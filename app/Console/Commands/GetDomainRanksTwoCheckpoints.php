...
class GetDomainRanksTwoCheckpoints extends Command
{
    protected $signature = 'domain:ranks_simple';

    protected $description = 'Domain rank differences from available data using 2 checkpoints';
    ...
    public function handle()
    {
        ...
        //SHOULD BE ABLE TO SELECT IN FRONT AND CONSIDER ALL FILES IN BETWEEN
