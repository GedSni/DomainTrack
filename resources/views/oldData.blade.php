                    ...
                    @for($i = 0; $i < count($dataMonths3); $i++)
                        <tr>
                            <td class="nameAndLinks">
                                <a rel="noreferrer noopener nofollow" class="link" href="http://{{$dataMonths3[$i]->name}}">{{$dataMonths3[$i]->name}}</a>
                                <a class="similarwebLink" rel="noreferrer noopener nofollow" href="https://www.similarweb.com/website/{{$dataMonths3[$i]->name}}">
            ...
            <div>
                <table class="table">
                    ...
                    @for($i = 0; $i < count($dataMonths6); $i++)
                        <tr>
                            <td class="nameAndLinks">
                                <a rel="noreferrer noopener nofollow"  class="link" href="http://{{$dataMonths6[$i]->name}}">{{$dataMonths6[$i]->name}}</a>
            ...
            <div>
                <table class="table">
                    ...
                    @for($i = 0; $i < count($dataMonths12); $i++)
                        <tr>
                            <td class="nameAndLinks">
                                <a rel="noreferrer noopener nofollow" class="link" href="http://{{$dataMonths12[$i]->name}}">{{$dataMonths12[$i]->name}}</a>
